...
GRAPH_MIN_X=0
GRAPH_MAX_X=8   ;# range 0-8
GRAPH_MIN_Y=0
GRAPH_MAX_Y=170 ;# range 0-170
...
#    print(repr(line))
    ...
    if cnt == 2:
        x_bot=x
        y_bot=y
        delta_t=round( (GRAPH_MAX_X-GRAPH_MIN_X)/num_of_int , 3 )
    ...
    if cnt > 2:
        ...
        fx=round( (x_max-x_min)/x_range*(x-x_top) , 2)
        fy=round( (y_max-y_min)/y_range*(y_range-(y-y_top)) , 2)
